...
import { UserReservationsComponent } from './company-admin/user-reservations/user-reservations.component';
...
const routes: Routes = [
  ...
  {path: 'user-reservations/:id', component: UserReservationsComponent, canActivate: [AuthGuard],data: {requiredRole: 'ROLE_COMPADMIN'}}, 
